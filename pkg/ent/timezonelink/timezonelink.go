...
const (
	// Label holds the string label denoting the timezonelink type in the database.
	Label = "time_zone_link"
	...
	// Table holds the table name of the timezonelink in the database.
	Table = "time_zone_links"
)

// Columns holds all SQL columns for timezonelink fields.
var Columns = []string{
	FieldID,
	FieldPrescriptionID,
	FieldTimezoneID,
...
// OrderOption defines the ordering options for the TimeZoneLink queries.
