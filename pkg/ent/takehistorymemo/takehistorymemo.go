...
const (
	// Label holds the string label denoting the takehistorymemo type in the database.
	Label = "take_history_memo"
	...
	// Table holds the table name of the takehistorymemo in the database.
	Table = "take_history_memos"
)

// Columns holds all SQL columns for takehistorymemo fields.
var Columns = []string{
	FieldID,
	FieldUserID,
	FieldTimezoneID,
...
// OrderOption defines the ordering options for the TakeHistoryMemo queries.
